 ...
 */
public class SerachJianHuoAdapter extends RecyclerView.Adapter<SerachJianHuoAdapter.ViewHolder> {
    List<SerachJianHuoEntity.DataBean.GuidesBean> datas;
    LayoutInflater inflater;
    Context context;

    public SerachJianHuoAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.userName.setText(datas.get(position).getAuthor());
        holder.mainTextView.setText(datas.get(position).getSubject());
        holder.sharingnum.setText(datas.get(position).getViews()+"");

        Picasso.with(context).load(datas.get(position).getHeader_image()).into(holder.mainImg);
    ...
    public void addAll(List<SerachJianHuoEntity.DataBean.GuidesBean> dd) {
        Log.d("1606",dd+"");
        datas.addAll(dd);
        Log.d("1606",datas+"");
